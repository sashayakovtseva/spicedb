...
type Option func(*ydbOptions)

func generateConfig(options []Option) (ydbOptions, error) {
	computed := ydbOptions{
...
func ReadConnHealthCheckInterval(interval time.Duration) Option {
	return func(po *ydbOptions) { po.readPoolOpts.ConnHealthCheckInterval = &interval }
}
...
func WriteConnHealthCheckInterval(interval time.Duration) Option {
	return func(po *ydbOptions) { po.writePoolOpts.ConnHealthCheckInterval = &interval }
}
...
func ReadConnMaxIdleTime(idle time.Duration) Option {
	return func(po *ydbOptions) { po.readPoolOpts.ConnMaxIdleTime = &idle }
}
...
func WriteConnMaxIdleTime(idle time.Duration) Option {
	return func(po *ydbOptions) { po.writePoolOpts.ConnMaxIdleTime = &idle }
}
...
func ReadConnMaxLifetime(lifetime time.Duration) Option {
	return func(po *ydbOptions) { po.readPoolOpts.ConnMaxLifetime = &lifetime }
}
...
func ReadConnMaxLifetimeJitter(jitter time.Duration) Option {
	return func(po *ydbOptions) { po.readPoolOpts.ConnMaxLifetimeJitter = &jitter }
}
...
func WriteConnMaxLifetime(lifetime time.Duration) Option {
	return func(po *ydbOptions) { po.writePoolOpts.ConnMaxLifetime = &lifetime }
}
...
func WriteConnMaxLifetimeJitter(jitter time.Duration) Option {
	return func(po *ydbOptions) { po.writePoolOpts.ConnMaxLifetimeJitter = &jitter }
}
...
func ReadConnsMinOpen(conns int) Option {
	return func(po *ydbOptions) { po.readPoolOpts.MinOpenConns = &conns }
}
...
func WriteConnsMinOpen(conns int) Option {
	return func(po *ydbOptions) { po.writePoolOpts.MinOpenConns = &conns }
}
...
func ReadConnsMaxOpen(conns int) Option {
	return func(po *ydbOptions) { po.readPoolOpts.MaxOpenConns = &conns }
}
...
func WriteConnsMaxOpen(conns int) Option {
	return func(po *ydbOptions) { po.writePoolOpts.MaxOpenConns = &conns }
}
...
func WatchBufferLength(watchBufferLength uint16) Option {
	return func(po *ydbOptions) { po.watchBufferLength = watchBufferLength }
}
...
func WatchBufferWriteTimeout(watchBufferWriteTimeout time.Duration) Option {
	return func(po *ydbOptions) { po.watchBufferWriteTimeout = watchBufferWriteTimeout }
}
...
func RevisionQuantization(bucketSize time.Duration) Option {
	return func(po *ydbOptions) { po.revisionQuantization = bucketSize }
}
...
func FollowerReadDelay(delay time.Duration) Option {
	return func(po *ydbOptions) { po.followerReadDelay = delay }
}
...
func MaxRevisionStalenessPercent(stalenessPercent float64) Option {
	return func(po *ydbOptions) { po.maxRevisionStalenessPercent = stalenessPercent }
}
...
func GCWindow(window time.Duration) Option {
	return func(po *ydbOptions) { po.gcWindow = window }
}
...
func ConnectRate(rate time.Duration) Option {
	return func(po *ydbOptions) { po.connectRate = rate }
}
...
func WithEnablePrometheusStats(enablePrometheusStats bool) Option {
	return func(po *ydbOptions) { po.enablePrometheusStats = enablePrometheusStats }
}
...
func WithEnableConnectionBalancing(connectionBalancing bool) Option {
	return func(po *ydbOptions) { po.enableConnectionBalancing = connectionBalancing }
}
